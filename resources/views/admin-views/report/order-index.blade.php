                        ...
                        <form action="{{ route('admin.report.set-date') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="mb-3">
                                        <input type="date" value="{{ date('Y-m-d', strtotime(session('from_date'))) }}"
                                            name="from" id="from_date" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="mb-3">
                                        <input type="date" name="to"
                                            value="{{ date('Y-m-d', strtotime(session('to_date'))) }}" id="to_date"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    <i
                                        class="tio-shopping-cart nav-icon {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    <i
                                        class="tio-shopping-cart-off nav-icon {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    <i
                                        class="tio-message-failed nav-icon {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    <i
                                        class="tio-flight-cancelled nav-icon {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}"></i>
        ...
        <div class="card mb-3">
            ...
            <div class="card-header flex-wrap">
                ...
                <div class="flex-start">
                    <h6 class="card-subtitle mt-1">{{ \App\CPU\translate('Total orders of') }} {{ date('Y') }} :
                    </h6>
                    <h6 class="h3 {{ Session::get('direction') === 'rtl' ? 'mr-sm-2' : 'ml-sm-2' }}">{{ round($total) }}
                    </h6>
                </div>
