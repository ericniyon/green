                        ...
                        <form action="{{ route('admin.attribute.store') }}" method="post">
                            ...
                            @foreach (json_decode($language) as $lang)
                                <div class="form-group {{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                    ...
                                    <label class="title-color" for="name">{{ \App\CPU\translate('Attribute') }}
                                        {{ \App\CPU\translate('Name') }}<span class="text-danger">*</span>
                                        ({{ strtoupper($lang) }})
                                    </label>
                                    <input type="text" name="name[]" class="form-control" id="name"
                                        placeholder="{{ \App\CPU\translate('Enter_Attribute_Name') }}"
                    ...
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="mb-0 d-flex align-items-center gap-2">{{ \App\CPU\translate('Attribute') }}
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-custom input-group-merge">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{ \App\CPU\translate('Search_by_Attribute_Name') }}"
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            toastr.success(
                                '{{ \App\CPU\translate('Attribute_deleted_successfully') }}'
                                );
                            location.reload();
                        }
                    });
