                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            ...
                            <img id="viewer" onerror="this.src='{{ asset('assets/back-end/img/160x160/img1.jpg') }}'"
                                class="avatar-img" src="{{ asset('storage/admin') }}/{{ $data->image }}" alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
                    <!-- End Card -->
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="name" id="firstNameLabel"
                                            placeholder="{{ \App\CPU\translate('Your first name') }}"
                                            aria-label="Your first name" value="{{ $data->name }}">
                            ...
                            <div class="row form-group">
                                <label for="phoneLabel"
                                    class="col-sm-3 col-form-label input-label">{{ \App\CPU\translate('Phone') }} <span
                            ...
                            <div class="row">
                                <label for="newEmailLabel"
                                    class="col-sm-3 input-label">{{ \App\CPU\translate('Profile_Image') }}</label>
