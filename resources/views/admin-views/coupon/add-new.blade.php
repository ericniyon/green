                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <select class="form-control" id="coupon_type" name="coupon_type" required>
                                        ...
                                        <option value="discount_on_purchase">
                                            {{ \App\CPU\translate('Discount_on_Purchase') }}</option>
                                ...
                                <div class="col-md-6 col-lg-4 form-group first_order">
                                    <label for="exampleFormControlInput1"
                                        class="title-color font-weight-medium d-flex">{{ \App\CPU\translate('limit') }}
                                ...
                                @foreach ($cou as $k => $c)
                                    <tr>
                                        ...
                                        <td class="text-capitalize">
                                            {{ \App\CPU\translate(str_replace('_', ' ', $c['coupon_type'])) }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <span>{{ \App\CPU\translate('Limit') }}:
                                                <strong>{{ $c['limit'] }},</strong></span>
                                            <span class="ml-1">{{ \App\CPU\translate('Used') }}:
                                                <strong>{{ $c['order_count'] }}</strong></span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-10 justify-content-center">
                                                <button class="btn btn-outline--primary square-btn btn-sm mr-1"
                                                    onclick="get_details(this)" data-id="{{ $c['id'] }}"
