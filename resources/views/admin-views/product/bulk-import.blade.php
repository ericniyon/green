        ...
        <div class="row" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
            <div class="col-12">
                <div class="card card-body">
                    ...
                    <p>3. {{ \App\CPU\translate('Once you have downloaded and filled the format file') }},
                        {{ \App\CPU\translate('upload it in the form below and submit.') }}</p>

                    <p>4.
                        {{ \App\CPU\translate('After uploading products you need to edit them and set product images and choices.') }}
                    </p>

                    <p>5. {{ \App\CPU\translate('You can get brand and category id from their list') }},
                        {{ \App\CPU\translate('please input the right ids.') }}</p>

                    <p>6. {{ \App\CPU\translate('You can upload your product images in product folder from gallery') }},
                        {{ \App\CPU\translate('and copy image`s path.') }}</p>
                </div>
            </div>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-auto">
                                        <div class="upload-file">
                                            ...
                                            <div class="upload-file__img_drag upload-file__img">
                                                <img src="{{ asset('/public/assets/back-end/img/drag-upload-file.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex flex-wrap gap-10 align-items-center justify-content-end">
                                <button type="reset" class="btn btn-secondary px-4"
                                    onclick="resetImg();">{{ \App\CPU\translate('reset') }}</button>
                                <button type="submit"
