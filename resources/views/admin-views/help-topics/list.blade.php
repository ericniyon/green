                                        ...
                                        <tr id="data-{{ $help->id }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-10">
                                                    <a class="btn btn-outline--primary btn-sm edit" data-toggle="modal"
                                                        data-target="#editModal" title="{{ \App\CPU\translate('Edit') }}"
                                                        data-id="{{ $help->id }}">
                                                        <i class="tio-edit"></i>
                                                    </a>
                    ...
                    <form action="{{ route('admin.helpTopic.add-new') }}" method="post" id="addForm">
                        ...
                        <div class="modal-body"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="answer" cols="5" rows="5"
                                    placeholder="{{ \App\CPU\translate('Type Answer') }}"></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                <form action="" method="post" id="editForm"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>{{ \App\CPU\translate('Question') }}</label>
                            <input type="text" class="form-control" name="question"
                                placeholder="{{ \App\CPU\translate('Type Question') }}" id="e_question" class="e_name">
                        </div>
                        ...
                        <div class="form-group">
                            <label>{{ \App\CPU\translate('Answer') }}</label>
                            <textarea class="form-control" name="answer" cols="5" rows="5"
                                placeholder="{{ \App\CPU\translate('Type Answer') }}" id="e_answer"></textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label for="ranking">{{ \App\CPU\translate('Ranking') }}</label>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            toastr.success(
                                '{{ \App\CPU\translate('FAQ deleted successfully') }}');
                            $('#data-' + id).hide();
                        }
                    });
                }
