                            ...
                            <div class="form-group">
                                @foreach (json_decode($language) as $lang)
                                    ...
                                    <div class="row {{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                        ...
                                        <div class="col-md-12">
                                            <label for="name" class="title-color">{{ \App\CPU\translate('Title') }}
                                                ({{ strtoupper($lang) }})
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-3">
                                        <label for="name"
                                            class="title-color">{{ \App\CPU\translate('start_date') }}</label>
                                        <input type="date" value="{{ date('Y-m-d', strtotime($deal['start_date'])) }}"
                                            name="start_date" required class="form-control">
                                    </div>
                                    <div class="col-md-6 mt-3">
                                        <label for="name"
                                            class="title-color">{{ \App\CPU\translate('end_date') }}</label>
                                        <input type="date" value="{{ date('Y-m-d', strtotime($deal['end_date'])) }}"
                                            name="end_date" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 pt-3">
                                        <label for="name" class="title-color">{{ \App\CPU\translate('Upload') }}
