                            ...
                            <div class="form-group">
                                @foreach (json_decode($language) as $lang)
                                    <div class="row {{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                        id="{{ $lang }}-form">
                                        <div class="col-md-12">
                                            <label for="name">{{ \App\CPU\translate('Title') }}
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-3">
                                        <label for="name"
                                            class="title-color">{{ \App\CPU\translate('Products') }}</label>
                                        <select
                                ...
                                @foreach ($deals as $k => $deal)
                                    <tr>
                                        ...
                                        <td><a href="#" target="_blank"
                                                class="font-weight-semibold title-color hover-c1">{{ $deal['title'] }}</a>
                                        </td>

                                        <td>{{ isset($deal->product) == true ? $deal->product->name : '\App\CPU\translate("not selected")' }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-10">
                                                ...
                                                <a title="{{ trans('Delete') }}"
                                                    class="btn btn-outline-danger btn-sm delete" id="{{ $deal['id'] }}">
