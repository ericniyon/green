                        ...
                        <form action="{{ route('admin.deal.flash') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    @foreach (json_decode($language) as $lang)
                                        <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                            ...
                                            <div class="form-group">
                                                <label for="name"
                                                    class="title-color font-weight-medium text-capitalize">{{ \App\CPU\translate('Title') }}
                                    ...
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color font-weight-medium text-capitalize">{{ \App\CPU\translate('start_date') }}</label>
                                        <input type="date" name="start_date" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color font-weight-medium text-capitalize">{{ \App\CPU\translate('end_date') }}</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="text-center">
                                            <img class="border radius-10" id="viewer"
                                                src="{{ asset('public\assets\front-end\img\5:1-placeholder.png') }}"
                                                alt="banner image" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color font-weight-medium text-capitalize">{{ \App\CPU\translate('Upload_image') }}</label>
                                        ...
                                        <div class="custom-file text-left">
                                            ...
                                            <label class="custom-file-label text-capitalize"
                                                for="customFileUpload">{{ \App\CPU\translate('choose_file') }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (\Carbon\Carbon::parse($deal['end_date'])->endOfDay()->isPast())
                                                <span class="badge badge-soft-danger">{{ \App\CPU\translate('expired') }}
                                                </span>
                                            @else
                                                <span class="badge badge-soft-success"> {{ \App\CPU\translate('active') }}
                                                </span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center justify-content-center gap-10">
                                                <a class="h-30 d-flex gap-2 align-items-center btn btn-soft-info btn-sm border-info"
                                                    ...
                                                    <img src="{{ asset('/public/assets/back-end/img/plus.svg') }}"
                                                        class="svg" alt="">
