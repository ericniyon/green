                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="title-color d-flex">{{ \App\CPU\translate('first') }}
                                    ...
                                    <div class="form-group">
                                        <label class="title-color d-flex">{{ \App\CPU\translate('last') }}
                                            {{ \App\CPU\translate('name') }}</label>
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($telephone_codes as $code)
                                                        <option value="{{ $code['code'] }}"
                                                            {{ $code['code'] == $delivery_man['country_code'] ? 'selected' : '' }}>
                                                            {{ $code['name'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="title-color d-flex">{{ \App\CPU\translate('identity') }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="identity_number"
                                            value="{{ $delivery_man['identity_number'] }}" class="form-control"
                                            placeholder="{{ \App\CPU\translate('Ex : DH-23434-LS') }}" required>
                                    </div>
                                    <div class="form-group">
