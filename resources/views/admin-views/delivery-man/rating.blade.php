                    ...
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-block">
                                ...
                                <p> {{ \App\CPU\translate('of') }} {{ $reviews->count() ?? 0 }}
                    ...
                    <form action="{{ url()->current() }}" method="GET">
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                placeholder="{{ \App\CPU\translate('Search by Order ID') }}" aria-label="Search orders"
                    ...
                    <div class="col-md-3">
                        <div>
                            <select class="form-control" name="rating">
                                ...
                                <option value="1" {{ $rating == 1 ? 'selected' : '' }}>{{ \App\CPU\translate('1') }}
                                </option>
                                <option value="2" {{ $rating == 2 ? 'selected' : '' }}>{{ \App\CPU\translate('2') }}
                                </option>
                                <option value="3" {{ $rating == 3 ? 'selected' : '' }}>{{ \App\CPU\translate('3') }}
                                </option>
                                <option value="4" {{ $rating == 4 ? 'selected' : '' }}>{{ \App\CPU\translate('4') }}
                                </option>
                                <option value="5" {{ $rating == 5 ? 'selected' : '' }}>{{ \App\CPU\translate('5') }}
                                </option>
                            </select>
                        </div>
                    </div>
                                        ...
                                        <div class="content p-0">
                                            @if (strlen($review['comment']) > 200)
                                                ...
                                                <span id="show-more-{{ $review->id }}" data-id="{{ $review->id }}"
                                                    onclick="toggle_btn(this)">...<a
                                                        href="javascript:void(0)">{{ \App\CPU\translate('show_more') }}</a></span>

                                                <span id="show-more-content-{{ $review->id }}"
                                                    class="show-more-content">
                                                    {{ substr($review['comment'], 200) }}
                                                    <span id="show-less-{{ $review->id }}"
                                                        data-id="{{ $review->id }}" onclick="toggle_btn(this)"><a
                                                            href="javascript:void(0)">{{ \App\CPU\translate('show_less') }}</a></span>
                                                @else
                                                    {{ $review['comment'] }}
                                            @endif
                                        </div>
