        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ \App\CPU\translate('upload') }}
                            {{ \App\CPU\translate('file') }} </h5>
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label"
                                        ...
                                        {{ \App\CPU\translate('images') }}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" name="file" id="customZipFileUpload"
            ...
            for (var i = 0; i < input.files.length; i++) {
                if (input.files && input.files[i]) {
                    ...
                    reader.onload = function(e) {
                        $('#files').append(
                            '<div class="col-md-2 col-sm-4 m-1"><img class="__empty-img" id="viewer" src="' + e
                            .target.result + '"/></div>');
                    }
