...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="modal fade" id="addFundModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
                        ...
                        <form action="{{ route('admin.customer.wallet.add-fund') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        <label class="input-label d-flex"
                                            for="customer">{{ \App\CPU\translate('customer') }}</label>
                                        <select id='form-customer' name="customer_id"
                                            data-placeholder="{{ \App\CPU\translate('select_customer') }}"
                                            class="js-data-example-ajax form-control w-100" required>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        <label class="input-label d-flex"
                                            for="amount">{{ \App\CPU\translate('amount') }}</label>

                                        <input type="number" class="form-control" name="amount" id="amount"
                                            step=".01" placeholder="Ex: 500" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="input-label d-flex align-items-center gap-1"
                                            for="referance">{{ \App\CPU\translate('reference') }}
                                            <small>({{ \App\CPU\translate('optional') }})</small></label>

                                        <input type="text" class="form-control" name="referance" placeholder="Ex: abc990"
                                            id="referance">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="transaction_type" id="" class="form-control"
                                            ...
                                            <option value="add_fund_by_admin"
                                                ...
                                                {{ \App\CPU\translate('add_fund_by_admin') }}</option>
                                            ...
                                            <option value="loyalty_point"
                                                ...
                                                {{ \App\CPU\translate('customer_loyalty_point') }}</option>
        ...
        $('#add_fund').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: '{{ \App\CPU\translate('you_want_to_add_fund') }}' + $('#amount').val() +
                    ' {{ \App\CPU\Helpers::currency_code() . ' ' . \App\CPU\translate('to') }} ' + $(
                        '#form-customer option:selected').text() + '{{ \App\CPU\translate('to_wallet') }}',
                type: 'info',
                    ...
                    $.post({
                        ...
                        success: function(data) {
                            if (data.errors) {
                                ...
                                toastr.success(
                                    '{{ \App\CPU\translate('fund_added_successfully') }}', {
                                        CloseButton: true,
                                        ProgressBar: true
                                    });
                                location.reload();
