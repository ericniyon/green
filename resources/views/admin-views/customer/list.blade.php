                        ...
                        <div class="d-flex justify-content-sm-end">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a class="dropdown-item"
                                        href="{{ route('admin.customer.export') }}">{{ \App\CPU\translate('excel') }}</a>
                                </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="switcher">
                                        <input type="checkbox" class="switcher_input" id="{{ $customer['id'] }}"
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            toastr.success(
                                '{{ \App\CPU\translate('Status updated successfully') }}');
                        }
                    });
                }
            })
