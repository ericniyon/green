                ...
                <div class="col-lg-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pl-2 d-flex gap-2 align-items-center mb-3">
                                ...
                                @else
                                    <label
                                        class="badge badge-soft-info mb-0">{{ \App\CPU\translate('Not_Seen_Yet') }}</label>
                                @endif
                            </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body d-flex flex-column gap-2">
                            <div class="mb-3">
                                <h5 class="px-2 py-1 badge-soft-info rounded mb-3 d-flex">
                                    {{ \App\CPU\translate($contact->name) }}</h5>
                                <div class="flex-start mb-1">
                                    <strong
                                        class="{{ Session::get('direction') === 'rtl' ? 'ml-1' : 'mr-1' }}">{{ \App\CPU\translate('Subject') }}:
                                    </strong>
                                    <div><strong>{{ $contact->subject }}</strong></div>
                                </div>
                                <div class="flex-start">
                                    <strong
                                        class="{{ Session::get('direction') === 'rtl' ? 'ml-1' : 'mr-1' }}">{{ \App\CPU\translate('Message') }}:
                                    </strong>
                                    <div>{{ $contact->message }}</div>
                                </div>
                            </div>
                            <div>
                                <h5 class="px-2 py-1 badge-soft-warning rounded mb-3 d-flex">
                            ...
                            <div class="row "
                                ...
                                <div class="col-12">
                                    <center>
                                        ...
                                        <label
                                            class="badge-soft-danger px-1">{{ \App\CPU\translate('Configure_your_mail_setup_first') }}.</label>
                                    </center>
                                        ...
                                        <div class="form-group mt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    <label
                                                        class="title-color">{{ \App\CPU\translate('Mail_Body') }}</label>
                                                    <textarea class="form-control h-100" name="mail_body" placeholder="{{ \App\CPU\translate('Please_send_a_Feedback') }}"
                                                        required></textarea>
                                                </div>
                                            </div>
                                        </div>
