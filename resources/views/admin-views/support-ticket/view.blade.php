                                ...
                                <div class="d-flex flex-wrap flex-sm-nowrap gap-3 justify-content-end">
                                    ...
                                    <select class="form-control border-color-c1 w-160"
                                        ...
                                        <option value="open" {{ $status == 'open' ? 'selected' : '' }}>
                                            {{ \App\CPU\translate('Open') }}</option>
                                        <option value="close" {{ $status == 'close' ? 'selected' : '' }}>
                                            {{ \App\CPU\translate('Close') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="media gap-3">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 align-items-center">
                                                ...
                                                <h6 class="mb-0">
                                                    {{ \App\CPU\translate(str_replace('_', ' ', $ticket->type)) }}</h6>
                                                <div
