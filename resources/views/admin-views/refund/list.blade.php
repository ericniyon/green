                    ...
                    <div class="col-12 mt-3 col-md-8">
                        <div class="d-flex gap-3 justify-content-md-end">
                            ...
                            <label class="switcher">
                                <input type="checkbox" class="switcher_input" onclick="filter_order()"
                            ...
                            <tr>
                                    ...
                                    @if ($refund->product != null)
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <div class="d-flex flex-column gap-1">
                                                ...
                                                <span class="fz-12">{{ \App\CPU\translate('QTY') }} :
                                                    {{ $refund->order_details->qty }}</span>
                                            </div>
                                        </div>
                                    @else
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-outline--primary btn-sm" title="{{ \App\CPU\translate('view') }}"
