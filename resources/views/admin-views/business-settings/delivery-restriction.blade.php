                ...
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <label class="switcher">
                            <input type="checkbox" onchange="status_change(this)" data-id="country_area"
                                class="status switcher_input"
                                data-url="{{ route('admin.business-settings.delivery-restriction.country-restriction-status-change') }}"
                                {{ isset($country_restriction_status->value) && $country_restriction_status->value == 1 ? 'checked' : '' }}>
                    ...
                    <div class="card-body country-disable">
                        <div class="row">
                            <div class="col-md-12">
                                <form
                                    action="{{ route('admin.business-settings.delivery-restriction.add-delivery-country') }}"
                                    method="post">
                                    @csrf
                                        ...
                                        <select
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country['code'] }}"
                                                    {{ in_array($country['code'], $stored_country_code) ? 'disabled' : '' }}>
                                                    {{ $country['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <a class="btn btn-outline-danger btn-sm square-btn"
                                                            href="javascript:" title="{{ \App\CPU\translate('Delete') }}"
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <div class="text-center p-4">
                                                            ...
                                                            <p class="mb-0">{{ \App\CPU\translate('No Country Found') }}
                                                            </p>
                                                        </div>
                                                    </td>
                                                </tr>
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <label class="switcher">
                            <input type="checkbox" onchange="status_change(this)" data-id="zip_area"
                                class="status switcher_input"
                                data-url="{{ route('admin.business-settings.delivery-restriction.zipcode-restriction-status-change') }}"
                                {{ isset($zip_code_area_restriction_status) && $zip_code_area_restriction_status->value == 1 ? 'checked' : '' }}>
                            <span class="switcher_control"></span>
                        </label>
                            ...
                            <div class="col-lg-12">
                                <form action="{{ route('admin.business-settings.delivery-restriction.add-zip-code') }}"
                                    ...
                                    <input type="text" class="form-control" name="zipcode"
                                        placeholder="{{ \App\CPU\translate('enter_zip_code') }}" data-role="tagsinput"
                                        required>
                                    <span
                                        class="pl-2 text-info">({{ \App\CPU\translate('multiple_zip_codes_can_be_inputted_by_comma_separating_or_pressing_enter_button') }})</span>
                                                    ...
                                                    <td colspan="3">
                                                        <div class="text-center p-4">
                                                            <img class="mb-3 w-160"
                                                                ...
                                                                alt="Image Description">
                                                            <p class="mb-0">
                                                                {{ \App\CPU\translate('No Zip Code Found') }}</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforelse
