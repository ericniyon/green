                        ...
                        @elseif($order['order_status'] == 'failed')
                            <span
                                ...
                                <span class="legend-indicator bg-info"
                                    style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;' }}"></span>{{ str_replace('_', ' ', $order['order_status'] == 'failed' ? 'Failed to Deliver' : $order['order_status']) }}
                            </span>
                        @elseif($order['order_status'] == 'processing' || $order['order_status'] == 'out_for_delivery')
                            <span
                                ...
                                <span class="legend-indicator bg-warning"
                                    style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;' }}"></span>{{ str_replace('_', ' ', $order['order_status'] == 'processing' ? 'Packaging' : $order['order_status']) }}
                            </span>
                    ...
                    <div class="card-header d-block">
                        <div class="row">
                            ...
                            <div class="col-12 text-right">
                                <div>
                                    <h6 class="text-capitalize __color-8a8a8a d-inline">{{ \App\CPU\translate('payment') }}
                                        {{ \App\CPU\translate('method') }} :</h6>
                                    <h6 class="mx-1 __color-8a8a8a d-inline">
                                        {{ str_replace('_', ' ', $order['payment_method']) }}</h6>
                                </div>
                                <div>
                                    <h6 class="__color-8a8a8a d-inline">{{ \App\CPU\translate('Payment') }}
                                        {{ \App\CPU\translate('reference') }} :</h6>
                                    <h6 class="mx-1 __color-8a8a8a d-inline">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            ...
                                            <div class="col col-md-1 align-self-center  p-0 product-name">
                                                <h6>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($detail['tax'])) }}
                                                </h6>
                                            </div>
                                            <div class="col col-md-2 align-self-center  p-0 product-name">
                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    @if ($order['coupon_discount_bearer'] == 'inhouse' && !in_array($order['coupon_code'], [0, null]))
                                        <dt class="col-sm-6">{{ \App\CPU\translate('coupon_discount') }}
                ...
                <div class="card">
                    ...
                    @if ($order->customer)
                        <div class="card-body"
                            ...
                            <div class="media align-items-center" href="javascript:">
                                <div
                                    class="icon icon-soft-info icon-circle p-0 {{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1"><strong>
                                        {{ $order->shippingAddress ? $order->shippingAddress['zip'] : 'Empty' }}</strong>
                                </div>
                            </div>
                            <div class="flex-start">
