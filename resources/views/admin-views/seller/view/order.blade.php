                ...
                <div class="row pt-2">
                    <div class="col-md-12">
                        <div class="card w-100">
                            ...
                            <!-- Card -->
                            @php(
    $pending_order = App\Model\Order::where(['seller_is' => 'seller'])->where(['seller_id' => $seller->id])->where('order_status', 'pending')->where('order_type', 'default_type')->get()
)
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @php(
    $delivered_order = App\Model\Order::where(['seller_is' => 'seller'])->where(['seller_id' => $seller->id])->where('order_status', 'delivered')->where('order_type', 'default_type')->get()
)
                                    <div class="col-md-4 mb-3 mb-md-0">
                                    ...
                                    @php(
    $total_order = App\Model\Order::where(['seller_is' => 'seller'])->where(['seller_id' => $seller->id])->where('order_type', 'default_type')->get()
)
                                    <div class="col-md-4">
                                ...
                                <table id="datatable"
                                    ...
                                    <thead class="thead-light thead-50 text-capitalize">
                                        <tr>
                                            ...
                                            <th>{{ \App\CPU\translate('Payment') }} {{ \App\CPU\translate('status') }}
                                            </th>
                                        ...
                                        @foreach ($orders as $key => $order)
                                            <tr class="status class-all">
                                                ...
                                                <td>
                                                    @if ($order->customer)
                                                        <a class="text-body text-capitalize"
                                                            ...
                                                            {{ isset($order->customer) ? $order->customer['f_name'] : '' }}
                                                            {{ isset($order->customer) ? $order->customer['l_name'] : '' }}
                                                        </a>
                                                    @else
                                                        <label
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span
                                                            class="badge badge-soft-danger fz-12">{{ \App\CPU\translate('unpaid') }}
                                                        </span>
                                                    @endif
                                                </td>
