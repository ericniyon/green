                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2 mb-md-0">
                                <div class="flex-start flex-wrap">
                                    ...
                                    <div class="mx-1">
                                        <h5>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\Convert::default($seller->amount)) }}
                                        </h5>
                                    </div>
                                </div>
                                <div class="flex-start flex-wrap">
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h4>{{ $seller->seller->bank_name ? $seller->seller->bank_name : 'No Data found' }}
                                    </h4>
                                </div>
                            </div>
                            <div class="flex-start">
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h6>{{ $seller->seller->holder_name ? $seller->seller->holder_name : 'No Data found' }}
                                    </h6>
                                </div>
                            </div>
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h6>{{ $seller->seller->account_no ? $seller->seller->account_no : 'No Data found' }}
                                    </h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-body"
                            ...
                            <div class="flex-start">
                                <div>
                                    <h5>{{ \App\CPU\translate('seller_b') }} : </h5>
                                </div>
                                <div class="mx-1">
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h5>{{ $seller->seller->shop->contact }}</h5>
                                </div>
                            </div>
                            <div class="flex-start">
                                <div>
                                ...
                                <div class="mx-1">
                                    <h5>{{ $seller->seller->shop->address }}</h5>
                                </div>
                            </div>
                ...
                <div class="card h-100">
                    <div class="card-body"
                        ...
                        <div class="flex-start">
                            ...
                            <div class="mx-1">
                                <h5>{{ $seller->seller->f_name }} {{ $seller->seller->l_name }}</h5>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
