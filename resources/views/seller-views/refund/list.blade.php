            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
                ...
                <div class="">
                    <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                        <img width="20" src="{{ asset('/public/assets/back-end/img/refund-request-list.png') }}"
                            alt="">
        ...
        <div class="card">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="title-color hover-c1"
                                        href="{{ route('seller.orders.details', [$refund->order_id]) }}">
                                        {{ $refund->order_id }}
                                    </a>
                                </td>
                                <td>
            ...
            @if (count($refund_list) == 0)
                <div class="text-center p-4">
                    <img class="mb-3 __w-7rem" src="{{ asset('assets/back-end') }}/svg/illustrations/sorry.svg"
