                                    ...
                                    <form class="">
                                        ...
                                        <div class="input-group-overlay input-group-merge input-group-custom">
                                            ...
                                            <input id="search" autocomplete="off" type="text"
                                                ...
                                                placeholder="{{ \App\CPU\translate('Search by Name') }}"
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="f_name" class="form-control"
                                        value="{{ old('f_name') }}" placeholder="{{ \App\CPU\translate('first_name') }}"
                                        required>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="l_name" class="form-control"
                                        value="{{ old('l_name') }}" placeholder="{{ \App\CPU\translate('last_name') }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control"
                                        value="{{ old('phone') }}" placeholder="{{ \App\CPU\translate('phone') }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" class="form-control"
                                        value="{{ old('country') }}" placeholder="{{ \App\CPU\translate('country') }}"
                                        required>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="zip_code" class="form-control"
                                        value="{{ old('zip_code') }}" placeholder="{{ \App\CPU\translate('zip_code') }}"
                                        required>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-control"
                                        value="{{ old('address') }}" placeholder="{{ \App\CPU\translate('address') }}"
                                        required>
                                </div>
                            </div>
                        </div>
...
@push('script_2')
    ...
    <script>
        ...
        function removeFromCart(key) {
            $.post('{{ route('seller.pos.remove-from-cart') }}', {
                _token: '{{ csrf_token() }}',
                key: key
            }, function(data) {
                console.log(data);
        ...
        function emptyCart() {
            Swal.fire({
                ...
                if (result.value) {
                    $.post('{{ route('seller.pos.emptyCart') }}', {
                        _token: '{{ csrf_token() }}'
                    }, function(data) {
                        $('#cart').empty().html(data.view);
                        toastr.info('{{ \App\CPU\translate('Item has been removed from cart') }}', {
        ...
        function updateCart() {
            $.post('<?php echo e(route('seller.pos.cart_items')); ?>', {
            ...
            if (qty !== "") {
                ...
                $.post('{{ route('seller.pos.updateQuantity') }}', {
                    ...
                    if (data.upQty === 'zeroNegative') {
                        toastr.warning(
                            '{{ \App\CPU\translate('Product_quantity_can_not_be_zero_or_less_than_zero_in_cart!') }}', {
                                CloseButton: true,
                                ProgressBar: true
                            });
                    }
