...
<div class="modal-body">
    <div class="media gap-3">
        ...
        <div class="d-flex align-items-center justify-content-center active">
            <img class="img-responsive rounded" src="{{ asset('storage/product/thumbnail') }}/{{ $product->thumbnail }}"
                onerror="this.src='{{ asset('assets/back-end/img/160x160/img2.jpg') }}'"
                data-zoom="{{ asset('storage/product') }}/{{ $product['image'] }}" alt="Product image" height="100">
        ...
        <div class="col-12">
            ...
            <form id="add-to-cart-form">
                            ...
                            <div class="color-select d-flex gap-2 flex-wrap" id="option1">
                                @foreach (json_decode($product->colors) as $key => $color)
                                    ...
                                    <label id="label-{{ $product->id }}-color-{{ $key }}"
                                        class="btn btn-sm mb-0 {{ $key == 0 ? 'border-add' : '' }}"
                    ...
                    <div class="product-quantity d-flex align-items-center">
                        <div class="d-flex align-items-center">
                            <span class="product-quantity-group">
                                <button class="btn-number" type="button" data-type="minus" data-field="quantity"
                                    disabled="disabled">
                                ...
                                <button class="btn-number" type="button" data-type="plus" data-field="quantity">
                                    <i class="tio-add"></i>
                                </button>
                            </span>
                        </div>
                ...
                <div class="row no-gutters mt-2 text-dark" id="chosen_price_div">
                    <div class="col-2">
                        <div class="product-description-label font-weight-bold">
