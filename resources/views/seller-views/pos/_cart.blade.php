    ...
    <div class="pt-4">
        <dl>
            ...
            <div class="d-flex gap-2 justify-content-between">
                <dt class="title-color text-capitalize font-weight-normal">{{ \App\CPU\translate('coupon') }}
                    {{ \App\CPU\translate('discount') }} :</dt>
                <dd>
        ...
        <form action="{{ route('seller.pos.order') }}" id='order_place' method="post">
            ...
            <div class="d-flex gap-2 justify-content-between align-items-center pt-3">
                ...
                <button type="button" onclick="form_submit()" class="btn btn--primary btn-block m-0"><i
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="coupon_code" class="form-control" name="coupon_code"
                            placeholder="Ex: SULTAN200">
                    </div>

                    <div class="d-flex justify-content-end">
                        <button class="btn btn--primary px-4" type="submit"
                            onclick="coupon_discount();">{{ \App\CPU\translate('apply') }}</button>
                    </div>
                </div>
            </div>
        </div>
