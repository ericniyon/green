                        ...
                        <div class="row ">
                            <div class="col-md-3 col-lg-3 hidden-xs hidden-sm">
                                <img class="img-circle __inline-21"
                                    src="{{ asset('assets/front-end') }}/img/contacts/blank.jpg" alt="User Pic">
                            </div>
                            ...
                            <div class=" col-md-9 col-lg-9 hidden-xs hidden-sm">
                                ...
                                @if ($contact->seen == 1)
                                    <label
                                        class="__rounded-10 text-success border p-1">{{ \App\CPU\translate('Seen') }}</label>
                                @else
                                    <label
                                        class="__rounded-10 text-danger border p-1">{{ \App\CPU\translate('Not Seen Yet') }}</label>
                                @endif
                                <br>
                                <table class="table table-user-information">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="__text-16px"> {{ $contact->message }}</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
