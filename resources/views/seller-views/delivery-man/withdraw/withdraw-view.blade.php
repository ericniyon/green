                    ...
                    <div class="card-body"
                        ...
                        <div
                            ...
                            <h3 class="text-capitalize">
                                {{ \App\CPU\translate('Delivery Man') }} {{ \App\CPU\translate('Withdraw') }}
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2 mb-md-0">
                                <div class="flex-start flex-wrap">
                                    ...
                                    <div class="mx-1">
                                        <h5>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\Convert::default($details->amount)) }}
                                        </h5>
                                    </div>
                                </div>
                                <div class="flex-start flex-wrap">
                            ...
                            <div class="col-md-4">
                                @if ($details->approved == 0)
                                    <button type="button"
                                        ...
                                        data-toggle="modal" data-target="#exampleModal">{{ \App\CPU\translate('proceed') }}
                ...
                <div class="card h-100">
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                            <div class="flex-start">
                                <div>
                                    <h4 class="text-nowrap">{{ \App\CPU\translate('bank_name') }} : </h4>
                                </div>
                                <div class="mx-1">
                                    <h4>{{ $details->delivery_men->bank_name ?? 'No Data found' }}</h4>
                                </div>
                            </div>
                            <div class="flex-start">
                                <div>
                                    <h6 class="text-nowrap">{{ \App\CPU\translate('Branch') }} : </h6>
                                </div>
                                <div class="mx-1">
                                    <h6>{{ $details->delivery_men->branch ?? 'No Data found' }}</h6>
                                </div>
                            </div>
                            <div class="flex-start">
                                <div>
                                    <h6 class="text-nowrap">{{ \App\CPU\translate('holder_name') }} : </h6>
                                </div>
                                <div class="mx-1">
                                    <h6>{{ $details->delivery_men->holder_name ?? 'No Data found' }}</h6>
                                </div>
                            </div>
                            <div class="flex-start">
                                <div>
                                    <h6 class="text-nowrap">{{ \App\CPU\translate('account_no') }} : </h6>
                                </div>
                                <div class="mx-1">
                                    <h6>{{ $details->delivery_men->account_no ?? 'No Data found' }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="card h-100">
                    <div class="card-body"
                        ...
                        <div class="flex-start">
                            <div>
                                <h5 class="text-nowrap">{{ \App\CPU\translate('name') }} : </h5>
                            </div>
                            <div class="mx-1">
                                <h5>{{ $details->delivery_men->f_name }} {{ $details->delivery_men->l_name }}</h5>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
                                <h5 class="text-nowrap">{{ \App\CPU\translate('Email') }} : </h5>
                            </div>
                            <div class="mx-1">
                                <h5>{{ $details->delivery_men->email }}</h5>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
                                <h5 class="text-nowrap">{{ \App\CPU\translate('Phone') }} : </h5>
                            </div>
                            <div class="mx-1">
                                <h5>{{ $details->delivery_men->phone }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
