    ...
    <main id="content" role="main" class="main">
        ...
        <div class="container py-5 py-sm-7">
            ...
            <a class="d-flex justify-content-center mb-5" href="javascript:">
                <img class="z-index-2 __w-8rem" src="{{ asset('storage/company/' . $e_commerce_logo) }}" alt="Logo"
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    ...
                    <ol class="list-unstyled font-size-md">
                        <li><span
                                class="text-primary mr-2">1.</span>{{ \App\CPU\translate('Fill in your email address below') }}.
                        </li>
                        <li><span
                                class="text-primary mr-2">2.</span>{{ \App\CPU\translate('We will send email you a temporary code') }}.
                        </li>
                        <li><span
                                class="text-primary mr-2">3.</span>{{ \App\CPU\translate('Use the code to change your password on our secure
                                                                                        website') }}.
                        </li>
                    </ol>
                    ...
                    @if ($verification_by == 'email')
                        <div class="card py-2 mt-4">
                            <form class="card-body needs-validation"
                                action="{{ route('seller.auth.forgot-password') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label
                                        for="recover-email">{{ \App\CPU\translate('Enter your email address') }}</label>
                                    <input class="form-control" type="email" name="identity" id="recover-email"
                                        required>
                                    <div class="invalid-feedback">
                                        {{ \App\CPU\translate('Please provide valid email address') }}.</div>
                                </div>
                    ...
                    @else
                        <div class="card py-2 mt-4">
                            <form class="card-body needs-validation"
                                ...
                                <div class="form-group">
                                    <label
                                        for="recover-email">{{ \App\CPU\translate('Enter your phone number') }}</label>
                                    <input class="form-control" type="text" name="identity" id="recover-email"
                                        required>
                                    <div class="invalid-feedback">
                                        {{ \App\CPU\translate('Please provide valid phone number') }}.</div>
                                </div>
                                <button class="btn btn--primary"
                                    type="submit">{{ \App\CPU\translate('Get new password') }}</button>
                            </form>
