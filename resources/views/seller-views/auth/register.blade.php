...
@section('content')
    ...
    <div class="container py-5 rtl" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
        ...
        <form class="__shop-apply" action="{{ route('shop.apply') }}" id="form-id" method="post"
                            ...
                            <g>
                                <g>
                                    <g>
                                        ...
                                        c-22-0.2-38.9-7.2-51.4-21.4C157.7,176.2,164.5,107.9,164.6,107.3z" fill="#000000"
                                        ...
                                        C447,415.5,446.9,388.8,446.8,383.6z" fill="#000000" data-original="#000000"
                                            class=""></path>
                                    </g>
                                </g>
                        </svg>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control form-control-user" id="exampleLastName" name="l_name"
                                value="{{ old('l_name') }}" placeholder="{{ \App\CPU\translate('last_name') }}" required>
                        </div>
                        ...
                        <div class="col-sm-6"><small class="text-danger">( *
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control form-control-user" minlength="6"
                                id="exampleRepeatPassword" placeholder="{{ \App\CPU\translate('repeat_password') }}"
                                required>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="custom-file mt-3">
                                ...
                                <label class="custom-file-label" for="customFileUpload">{{ \App\CPU\translate('Upload') }}
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 ">
                            <input type="text" class="form-control form-control-user" id="shop_name" name="shop_name"
                                placeholder="{{ \App\CPU\translate('shop_name') }}"
                            ...
                            <div class="col-12">
                                <div class="row py-2">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control __h-40" name="default_captcha_value"
                                            value="" placeholder="{{ \App\CPU\translate('Enter captcha value') }}"
                                    ...
                                    <div class="col-6 input-icons mb-2 w-100 rounded bg-white">
                                        <a onclick="javascript:re_captcha();"
                                            ...
                                            <img src="{{ URL('/seller/auth/code/captcha/1') }}" class="rounded __h-40"
