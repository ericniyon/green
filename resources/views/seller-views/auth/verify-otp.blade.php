    ...
    <main id="content" role="main" class="main __inline-20">
        ...
        <div class="container py-5 py-sm-7">
            ...
            <a class="d-flex justify-content-center mb-5" href="javascript:">
                <img class="z-index-2 __w-rem" src="{{ asset('storage/company/' . $e_commerce_logo) }}" alt="Logo"
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="card py-2 mt-4">
                            <form class="card-body needs-validation"
                                action="{{ route('seller.auth.otp-verification') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label>{{ \App\CPU\translate('Enter your OTP') }}</label>
                                    <div id="divOuter">
                                        <div id="divInner">
                                            <input id="partitioned" class="form-control" name="otp" type="text"
                                                maxlength="4" />
                                        </div>
                                    </div>
                                </div>
