                    ...
                    <div class="card py-2 mt-4">
                        <form class="card-body needs-validation" novalidate method="POST"
                            ...
                            <div class="form-group">
                                <label
                                    for="si-password">{{ \App\CPU\translate('New') }}{{ \App\CPU\translate('password') }}</label>
                                <div class="password-toggle">
                                    ...
                                    <div class="invalid-feedback">{{ \App\CPU\translate('provide_valid_password') }}.
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <button class="btn btn--primary"
                                type="submit">{{ \App\CPU\translate('reset_password') }}</button>
                        </form>
                    </div>
                </div>
            </div>
