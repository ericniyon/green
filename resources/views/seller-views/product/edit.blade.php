                            ...
                            @foreach (json_decode($language) as $lang)
                                ...
                                <div class="{{ $lang != 'en' ? 'd-none' : '' }} lang_form" id="{{ $lang }}-form">
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea name="description[]" class="textarea  editor-textarea" required>{!! $translate[$lang]['description'] ?? $product['details'] !!}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <label class="badge badge-soft-info">{{ \App\CPU\translate('Percent') }} ( %
                                            )</label>
                                ...
                                <div class="sku_combination" id="sku_combination">
                                    @include('seller-views.product.partials._edit_sku_combinations', [
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3 physical_product_show" id="shipping_cost">
                                        ...
                                        <input type="number" min="0"
                                            value="{{ \App\CPU\BackEndHelper::usd_to_currency($product->shipping_cost) }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-3 mt-md-0">
                                    <div class="mb-2 d-flex flex-wrap gap-1 align-items-baseline">
                                        <label for="name"
                                            class="title-color mb-0">{{ \App\CPU\translate('Upload thumbnail') }}</label>
                                        <small class="text-info">* ( {{ \App\CPU\translate('ratio') }} 1:1 )</small>
                                    </div>
                                    <div class="row" id="meta_img">
                                        <div class="col-6">
