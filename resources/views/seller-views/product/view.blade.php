                    ...
                    <div class="col-md">
                        <ul class="list-unstyled list-unstyled-py-2 mb-0">
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">5
                                    {{ \App\CPU\translate('star') }}</span>
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">4
                                    {{ \App\CPU\translate('star') }}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">3
                                    {{ \App\CPU\translate('star') }}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">2
                                    {{ \App\CPU\translate('star') }}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">1
                                    {{ \App\CPU\translate('star') }}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-4 col-lg-2">
                                        <div class="product-description-label mt-2">
                                            {{ \App\CPU\translate('Available_Color') }}:
                                        </div>
                                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex gap-3 flex-wrap align-items-center">
                                            ...
                                            <div>
                                                <span
                                                    class="d-block h5 text-hover-primary mb-0">{{ $review->customer['f_name'] ?? '' }}
                                                    {{ $review->customer['l_name'] ?? '' }} <i
