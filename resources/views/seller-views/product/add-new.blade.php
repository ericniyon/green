                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3 " id="digital_product_type_show">
                                        ...
                                        <select name="digital_product_type" id="digital_product_type" class="form-control"
                                            ...
                                            <option value="ready_product">{{ \App\CPU\translate('Ready Product') }}
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    <div class="mb-2">
                                        <label
                                            class="title-color mb-0">{{ \App\CPU\translate('Upload_product_images') }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label for="name"
                                            class="title-color mb-0">{{ \App\CPU\translate('Upload_thumbnail') }}</label>
                                        <span class="text-info">* ( {{ \App\CPU\translate('ratio 1:1') }} )</span>
                                    </div>
                                    <div>
