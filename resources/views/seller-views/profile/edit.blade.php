        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{ route('seller.profile.update', [$data->id]) }}" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            ...
                            <img id="viewer" onerror="this.src='{{ asset('assets/back-end/img/160x160/img1.jpg') }}'"
                                class="avatar-img" src="{{ asset('storage/seller') }}/{{ $data->image }}" alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
                    <!-- End Card -->
                    ...
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header">
                            <h5 class="mb-0">{{ \App\CPU\translate('Basic') }} {{ \App\CPU\translate('information') }}
                            </h5>
                        </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="name" class="title-color">{{ \App\CPU\translate('First') }}
                                                {{ \App\CPU\translate('Name') }} <span class="text-danger">*</span></label>
                                            <input type="text" name="f_name" value="{{ $data->f_name }}"
                                                class="form-control" id="name" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="name" class="title-color">{{ \App\CPU\translate('Last') }}
                                                {{ \App\CPU\translate('Name') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 mb-3">
                                    <div class="text-info mb-2">( * {{ \App\CPU\translate('country_code_is_must') }}
                                        {{ \App\CPU\translate('like_for_BD_880') }} )</div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h5 class="mb-0">{{ \App\CPU\translate('Change') }} {{ \App\CPU\translate('your') }}
                            {{ \App\CPU\translate('password') }}</h5>
                    </div>
