                            ...
                            <div class="text-sm-right">
                                <div class="d-flex flex-wrap gap-10">
                                    <div class="">
                                        ...
                                        @else
                                            <button class="btn btn-warning px-4"><i class="tio-map"></i>
                                ...
                                <div class="d-flex flex-column gap-2 mt-3">
                                    ...
                                    <div class="order-status d-flex justify-content-sm-end gap-10 text-capitalize">
                                        ...
                                        @elseif($order['order_status'] == 'failed')
                                            <span
                                                class="badge badge-danger font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{ str_replace('_', ' ', 'Failed To Deliver') }}</span>
                                        @elseif($order['order_status'] == 'processing' || $order['order_status'] == 'out_for_delivery')
                                            <span
                                                class="badge badge-soft-warning font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{ str_replace('_', ' ', $order['order_status'] == 'processing' ? 'Packaging' : $order['order_status']) }}</span>
                                        @elseif($order['order_status'] == 'delivered' || $order['order_status'] == 'confirmed')
                                            <span
                                                class="badge badge-soft-success font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{ str_replace('_', ' ', $order['order_status']) }}</span>
                                        @else
                                            <span
                                                class="badge badge-soft-danger font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{ str_replace('_', ' ', $order['order_status']) }}</span>
                                        @endif
                                    </div>
                                    ...
                                    @if ($order->payment_method != 'cash_on_delivery' && $order->payment_method != 'pay_by_wallet')
                                        <div class="reference-code d-flex justify-content-sm-end gap-10 text-capitalize">
                                            <span class="title-color">{{ \App\CPU\translate('Reference') }}
                                                {{ \App\CPU\translate('Code') }} :</span>
                                    ...
                                    <div class="payment-status d-flex justify-content-sm-end gap-10">
                                        ...
                                        @if ($order['payment_status'] == 'paid')
                                            <span
                                                class="text-success font-weight-bold text-capitalize">{{ \App\CPU\translate('Paid') }}</span>
                                        @else
                                            <span
                                                class="text-danger font-weight-bold text-capitalize">{{ \App\CPU\translate('Unpaid') }}</span>
                                        @endif
                                    </div>
                                    ...
                                    @foreach ($order->details as $key => $detail)
                                        @if ($detail->product)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media align-items-center gap-10">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div><strong>{{ \App\CPU\translate('qty') }} :</strong>
                                                                {{ $detail->qty }}</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($detail['tax'])) }}
                                                </td>
                                                ...
                                                <div class="modal fade" id="fileUploadModal-{{ $detail->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <form
                                                                action="{{ route('seller.orders.digital-file-upload-after-sell') }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mt-1 text-info">
                                                                        {{ \App\CPU\translate('File type: jpg, jpeg, png, gif, zip, pdf') }}
                                                                    </div>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row gy-1 text-sm-right">
                                    ...
                                    <dt class="col-sm-6 font-weight-normal">{{ \App\CPU\translate('coupon_discount') }}
                                    </dt>
                                    <dd class="col-sm-6 font-weight-normal title-color">
                                        -
                                    ...
                                    @if ($order['coupon_discount_bearer'] == 'inhouse' && !in_array($order['coupon_code'], [0, null]))
                                        <dt class="col-sm-6 font-weight-normal">
                                            {{ \App\CPU\translate('coupon_discount') }}
                                            ({{ \App\CPU\translate('admin_bearer') }})</dt>
                                        <dd class="col-sm-6 font-weight-normal title-color">
                                            +
                                            {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($coupon_discount)) }}
                                        </dd>
            ...
            <div class="col-lg-4 col-xxl-3 d-flex flex-column gap-3">
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        <div>
                            ...
                            <select name="order_status" onchange="order_status(this.value)" class="status form-control"
                                ...
                                <option value="processing" {{ $order->order_status == 'processing' ? 'selected' : '' }}>
                                    {{ \App\CPU\translate('Packaging') }} </option>
                                ...
                                @if ($shippingMethod == 'sellerwise_shipping')
                                    ...
                                    <option value="failed" {{ $order->order_status == 'failed' ? 'selected' : '' }}>
                                        {{ \App\CPU\translate('Failed_to_deliver') }} </option>
                        ...
                        @if ($order['payment_method'] == 'cash_on_delivery' && $shipping_method == 'sellerwise_shipping')
                            <div>
                                <label
                                    class="font-weight-bold title-color fz-14">{{ \App\CPU\translate('Payment Status') }}</label>
                                ...
                                @if ($shipping_method == 'sellerwise_shipping')
                                    ...
                                    <li class="choose_delivery_man mt-3">
                                        ...
                                        <input type="number" id="deliveryman_charge"
                                            onkeyup="amountDateUpdate(this, event)"
                            ...
                            <div class="media">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
                                    ...
                                    <span class="title-color">
                                        <strong>{{ \App\Model\Order::where('customer_id', $order['customer_id'])->count() }}
                                        </strong>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="media">
                            <div class="mr-3">
                                <img class="avatar rounded avatar-70" onerror="this.src=''"
                            ...
                            @if (!empty($order->seller->shop))
                                <div class="media-body d-flex flex-column gap-2">
                                    ...
                                    <span class="title-color"><strong>{{ $total_delivered }}</strong>
                                        {{ \App\CPU\translate('Orders Served') }}</span>
                                    <span class="title-color">
