                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('seller.orders.order-bulk-export', ['status' => $status, 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search]) }}">
                            ...
                            @foreach ($orders as $k => $order)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span
                                                class="badge badge-soft-danger">{{ \App\CPU\translate('unpaid') }}</span>
                                        @endif
                                    </td>
