                                ...
                                @foreach ($coupons as $k => $coupon)
                                    <tr>
                                        ...
                                        <td class="text-capitalize">
                                            {{ \App\CPU\translate(str_replace('_', ' ', $coupon['coupon_type'])) }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <span>{{ \App\CPU\translate('Limit') }}:
                                                <strong>{{ $coupon['limit'] }},</strong></span>
                                            <span class="ml-1">{{ \App\CPU\translate('Used') }}:
                                                <strong>{{ $coupon['order_count'] }}</strong></span>
                                        </td>
                                            ...
                                            <label class="switcher">
                                                @if (
                                                    $coupon->added_by == 'seller' ||
                                                        ($coupon->added_by == 'admin' &&
                                                            $coupon->coupon_bearer == 'seller' &&
                                                            $coupon->seller_id == auth('seller')->id()))
