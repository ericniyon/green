                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title"
                                        value="{{ $coupon['title'] }}" placeholder="{{ \App\CPU\translate('Title') }}"
                                        required>
                                </div>
                                <div class="col-md-6 col-lg-4 form-group">
                                    <label for="name"
                                ...
                                <div class="col-md-6 col-lg-4 form-group free_delivery">
                                    ...
                                    <input type="number" min="0" max="1000000" step=".01" name="discount"
                                        ...
                                        value="{{ $coupon['discount_type'] == 'amount' ? \App\CPU\Convert::default($coupon['discount']) : $coupon['discount'] }}"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" max="1000000" step=".01" name="min_purchase"
                                        ...
                                        value="{{ \App\CPU\Convert::default($coupon['min_purchase']) }}"
                                ...
                                <div class="col-md-6 col-lg-4 form-group free_delivery" id="max-discount">
                                    ...
                                    <input type="number" min="0" max="1000000" step=".01"
                                        ...
                                        value="{{ \App\CPU\Convert::default($coupon['max_discount']) }}"
