    ...
    $flash_deals = \App\Model\FlashDeal::with([
        ...
        @if (isset($flash_deals))
            <section class="overflow-hidden">
                <div class="container">
                    <div class="flash-deal-view-all-web row d-none d-lg-flex justify-content-{{ Session::get('direction') === 'rtl' ? 'start' : 'end' }}"
        ...
        @if ($business_mode == 'multi')
            @if (count($top_sellers) > 0)
                <section class="container rtl mt-5">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="seller-list-title">
                                        <span class="font-semibold">{{ \App\CPU\translate('top_sellers') }}</span>
                                    </div>
                                            ...
                                            @if ($seller->shop)
                                                <div class="owl-item active" style="width: 285px; margin-right: 26px;"
                                                    bis_skin_checked="1"><a
                                                        href="{{ route('shopView', ['id' => $seller['id']]) }}"
                                                        ...
                                                        <div class="name-area" bis_skin_checked="1">
                                                            ...
                                                            <div class="info pt-2" bis_skin_checked="1">
                                                                <h5>{{ Str::limit($seller->shop->name, 14) }}</h5>
                                                        ...
                                                        <div class="info-area" bis_skin_checked="1">
                                                            ...
                                                            <div class="info-item" bis_skin_checked="1">
                                                                <h6 class="web-text-primary">
                                                                    {{ \App\Model\Product::where('added_by', 'seller')->where('user_id', $seller->id)->count() }}
                                                                </h6>
                                                                <span>Products</span>
                                                            </div>
                                                        </div>
                        ...
                        @else
                            ...
                            @if (isset($product))
                                <div class="d-flex justify-content-center align-items-center ">
                                    <h1 class="text-primary"> {{ \App\CPU\translate('recommended_product') }}</h1>
                                </div>
                                <div class="recomanded-product-card">
                                                ...
                                                <div class="best-selling-details">
                                                    ...
                                                    <div class="rating-show">
                                                        <span class="d-inline-block font-size-sm text-body">
                                                            ...
                                                            @endfor
                                                            <label class="badge-style">(
                                                                {{ $bestSell->product->reviews_count }} )</label>
                                                        </span>
                                                    </div>
                                                    <div>
                                                        @if ($bestSell->product->discount > 0)
                                                ...
                                                <div class="top-rated-details">
                                                    ...
                                                    <div class="rating-show">
                                                        <span class="d-inline-block font-size-sm text-body">
                                                            ...
                                                            @endfor
                                                            <label class="badge-style">(
                                                                {{ $top->product->reviews_count }} )</label>
                                                        </span>
                                                    </div>
                                                    <div>
                                                        @if ($top->product->discount > 0)
