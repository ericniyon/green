                    ...
                    @foreach ($order as $product)
                        ...
                        <div class="d-sm-flex justify-content-between mb-4 pb-3 pb-sm-2 border-bottom">
                            ...
                            <div class="pt-2 pl-sm-3 mx-auto mx-sm-0 text-center">
                                <div class="text-muted mb-2">{{ \App\CPU\translate('Quantity') }} : {{ $product['qty'] }}
                                </div>
                            </div>
                            <div class="pt-2 pl-sm-2 mx-auto mx-sm-0 text-center">
                                <div class="text-muted mb-2">{{ \App\CPU\translate('Tax') }} :
                                    {{ \App\CPU\Helpers::currency_converter($product['tax']) }}
                                </div>
                            </div>
                            <div class="pt-2 pl-sm-3 mx-auto mx-sm-0 text-center">
                                <div class="text-muted mb-2">{{ \App\CPU\translate('Subtotal') }} :
                                    {{ \App\CPU\Helpers::currency_converter($product['price'] * $product['qty']) }}</div>
                            </div>
                        </div>
        ...
        <div class="row __bg-e2f0ff w-100 m-0">
            ...
            <div class="col-sm-4">
                <div class="pt-2 pb-2 text-center rounded-lg">
                    ...
                    <span class="text-uppercase font-semibold"
                        style="color: {{ $web_config['primary_color'] }}">{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $orderDetails['updated_at'])->format('Y-m-d') }}</span>
                </div>
            </div>
        </div>
        <!-- Progress-->
                            ...
                            <div class="nav-link ">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body text-center">
                                        ...
                                        <h6 class="media-tab-title text-nowrap mb-0">
                                            {{ \App\CPU\translate('Packaging order') }}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
