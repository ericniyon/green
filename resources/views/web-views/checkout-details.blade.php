                                        ...
                                        <form class="needs-validation" autocomplete="off" id="login-form"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="si-password">{{ \App\CPU\translate('Password') }}</label>
                                        ...
                                        <form class="needs-validation_" autocomplete="off" novalidate id="sign-up-form"
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="su-name">{{ \App\CPU\translate('first_name') }}</label>
                                                        <input class="form-control" type="text" name="f_name"
                                                            placeholder="John" required>
                                                        <div class="invalid-feedback">
                                                            {{ \App\CPU\translate('Please fill in your name') }}.</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="su-name">{{ \App\CPU\translate('last_name') }}
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="phone" type="number"
                                                            id="su-phone"
                                                            placeholder="{{ \App\CPU\translate('01700000000') }}"
                                                            required>
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="su-password">{{ \App\CPU\translate('Password') }}</label>
                                                        <div class="password-toggle">
                                                            <input class="form-control" name="password" type="password"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="password-toggle">
                                                            <input class="form-control" name="con_password"
                                                                type="password" id="su-password-confirm" required>
                                                            <label class="password-toggle-btn">
                                                                <input class="custom-control-input" type="checkbox"><i
                                                                    class="czi-eye password-toggle-indicator"></i><span
                                                                    class="sr-only">{{ \App\CPU\translate('Show password') }}</span>
                ...
                <div class="row">
                    <div class="col-6">
                        <a class="btn btn-secondary btn-block" href="{{ route('shop-cart') }}">
                            <i
                                class="czi-arrow-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }} mt-sm-0 mx-1"></i>
                            <span class="d-none d-sm-inline">{{ \App\CPU\translate('Back') }}
                                {{ \App\CPU\translate('to') }} {{ \App\CPU\translate('Cart') }} </span>
                    ...
                    <div class="col-6">
                        @if (auth('customer')->check())
                            <a class="btn btn--primary btn-block" href="{{ route('shop-cart') }}">
                                ...
                                <i
                                    class="czi-arrow-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }} mt-sm-0 mx-1"></i>
                            </a>
                        @endif
                    </div>
                </div>
