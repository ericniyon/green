...
<div class="product-single-hover">
    <div class="overflow-hidden position-relative">
        <div class="inline_product clickable rtl" style="background:{{ $web_config['primary_color'] }}10;">
        ...
        <div class="text-center quick-view">
            ...
            @else
                <a class="btn btn--primary btn-sm" href="javascript:" onclick="quickView('{{ $product->id }}')">
