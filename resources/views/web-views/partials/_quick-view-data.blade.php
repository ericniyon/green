            ...
            <div class="details __h-100">
                ...
                <div class="d-flex flex-wrap align-items-center mb-2 pro">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <span
                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{ Session::get('direction') === 'rtl' ? 'ml-2 mr-1' : 'ml-1 mr-2' }} pl-2 pr-2">{{ $overallRating[1] }}
                            {{ \App\CPU\translate('reviews') }}</span>
                        <span style="width: 0px;height: 10px;border: 0.5px solid #707070; margin-top: 6px"></span>
                        <span
                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{ Session::get('direction') === 'rtl' ? 'ml-2 mr-1' : 'ml-1 mr-2' }} pl-2 pr-2">{{ $countOrder }}
                            {{ \App\CPU\translate('orders') }} </span>
                        <span style="width: 0px;height: 10px;border: 0.5px solid #707070; margin-top: 6px"> </span>
                        <span
                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{ Session::get('direction') === 'rtl' ? 'ml-2 mr-1' : 'ml-1 mr-2' }} pl-2 pr-2">
                            {{ $countWishlist }} {{ \App\CPU\translate('wishlist') }}</span>
                            ...
                            <div class="input-group input-group--style-2 pr-3" style="width: 160px;">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-number" product-type="{{ $product->product_type }}"
                                        type="button" data-type="plus" data-field="quantity" style="padding: 10px">
                                        +
                                    </button>
                                </span>
                            </div>
