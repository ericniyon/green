    ...
    <div class="p-2" style="margin-bottom: 20px">
        <div class="row product-review d-flex ">
            <div class="col-md-3 d-flex mb-3 {{ Session::get('direction') === 'rtl' ? 'pl-5' : 'pr-5' }}">
                <div class="media media-ie-fix  {{ Session::get('direction') === 'rtl' ? 'ml-4 pl-2' : 'mr-4 pr-2' }}">
                    ...
                    <div class="media-body {{ Session::get('direction') === 'rtl' ? 'pr-3' : 'pl-3' }} text-body">
                        ...
                        <div class="d-flex ">
                            ...
                            <div class="text-body" style="font-weight: 400;font-size: 15px;">
                                {{ $productReview->rating }}/{{ \App\CPU\translate('5') }} </div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-2 text-body">
                <span
                    style="float: right;font-weight: 400;font-size: 13px;">{{ $productReview->updated_at->format('M-d-Y') }}</span>
            </div>
        </div>
    </div>
@endforeach
