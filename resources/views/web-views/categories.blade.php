...
@section('content')
    <!-- Page Content-->
    <div class="container p-3 rtl __inline-52"
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="row" id="ajax-categories">
                    <label
                        class="col-md-12 text-center mt-5">{{ \App\CPU\translate('Select your desire category') }}.</label>
                </div>
                <!-- Pagination-->
            </div>
        </div>
        ...
        function get_categories(route) {
            $.get({
                ...
                success: function(response) {
                    $('html,body').animate({
                        scrollTop: $("#ajax-categories").offset().top
                    }, 'slow');
