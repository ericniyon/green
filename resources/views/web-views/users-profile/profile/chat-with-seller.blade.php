...
@section('content')
    <div class="__chat-seller">
        ...
        <div class="container rtl">
            <h3 class="text-center py-3 headerTitle m-0">
                {{ Request::is('chat/seller') ? \App\CPU\translate('chat_with_seller') : \App\CPU\translate('chat_with_delivery-man') }}
            </h3>
        </div>
                                ...
                                <div class="headind_srch">
                                    <form
                                        ...
                                        <input
                                            ...
                                            id="myInput" type="text" placeholder="{{ \App\CPU\translate('Search') }}"
                                            aria-label="Search">
                                                ...
                                                <div class="chat_people" id="chat_people">
                                                    ...
                                                    <div class="chat_ib">
                                                        <h5 class="seller @if ($shop->seen_by_customer) active-text @endif"
                                                            id="{{ $shop->delivery_man_id ? $shop->delivery_man_id : $shop->shop_id }}">
                                                    ...
                                                    @if ($chat->sent_by_seller ? $chat->sent_by_seller : $chat->sent_by_delivery_man)
                                                        <div class="incoming_msg">
                                                            <div class="incoming_msg_img"><img
                                                                    src="@if ($chat->image == 'def.png') {{ asset('storage/' . $chat->image) }} @else {{ $shop->delivery_man_id ? asset('storage/delivery-man/' . $last_chat->delivery_man->image) : asset('storage/shop/' . $last_chat->shop->image) }} @endif"
                                                                    alt="sunil"></div>
                                                            <div class="received_msg">
                                                                <div class="received_withd_msg">
                                                                    ...
                                                                    <span class="time_date">
                                                                        ...
                                                                        {{ $chat->created_at->format('M d') }} </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                            ...
                                            <div class="input_msg_write">
                                                <form
                                                    ...
                                                    <input
                                                        ...
                                                        id="msgInputValue" type="text"
                                                        placeholder="{{ \App\CPU\translate('Send a message') }}"
                                                        aria-label="Search">
                                                    <input class="aSend __w-45px" type="submit" id="msgSendBtn"
                    ...
                    success: function(data) {
                        ...
                        if (data.length != 0) {
                            data.map((element, index) => {
                                ...
                                let date = month[dateTime.getMonth().toString()] + " " +
                                ...
                                if (element.sent_by_customer) {
                                    ...
                                    let img_path = element.image == 'def.png' ?
                                        `{{ asset('storage/shop') }}/${element.image}` :
                                        `{{ isset($shop->delivery_man_id) && $shop->delivery_man_id ? asset('storage/delivery-man') : asset('storage/shop') }}/${element.image}`;
