                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-6 col-md-6">
                                        ...
                                        <span>{{ \App\CPU\translate('QTY') }} :
                                            {{ $refund->order_details->qty }}</span><br>
                                        <span>{{ \App\CPU\translate('price') }} :
                                            {{ \App\CPU\Helpers::currency_converter($refund->order_details->price) }}</span><br>
                                    ...
                                    <div
                                        class="col-12 col-sm-10 col-md-4 text-center d-flex flex-column pl-0 mt-4 mt-sm-4 pl-sm-5">
                                        <div class="row justify-content-md-end mb-3">
                                            <div class="col-md-10 col-lg-10">
                                                <div class="row text-sm-right">
                                                    ...
                                                    <div class="col-sm-7">{{ \App\CPU\translate('total_discount') }} :
                                                    </div>
                                                    <div class="col-sm-5 ">
                        ...
                        <div class="card mt-2">
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <span class="col-sm-5">{{ \App\CPU\translate('total_refund_amount') }} :
                        ...
                        <div class="card mt-2">
                            <div class="card-body">
                                ...
                                @if ($refund->status == 'rejected')
                                    <div class="col-12">
                                        <span><b>{{ \App\CPU\translate('rejected_reason') }}</b> : </span>
                                        {{ $refund->rejected_note }}
                                    </div>
                                @endif
                                @if ($refund->status == 'refunded')
                                    <div class="col-12">
                                        <span><b>{{ \App\CPU\translate('payment_info') }}</b> : </span>
                                        {{ $refund->payment_info }}
                                    </div>
                                @endif
                            </div>
