                            ...
                            <form action="{{ route('address-update') }}" method="post">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="donate-now">
                                            <li class="address_type_bl">
                                                ...
                                                <label for="b25"
                                                    class="component">{{ \App\CPU\translate('shipping') }}</label>
                                            </li>
                                            <li class="address_type_bl">
                                                ...
                                                <label for="b50"
                                                    class="component">{{ \App\CPU\translate('billing') }}</label>
                                            </li>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" id="address" type="text" name="address" required>{{ $shippingAddress->address }}</textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('account-address') }}"
                                        class="closeB btn btn-secondary">{{ \App\CPU\translate('close') }}</a>
                                    <button type="submit" class="btn btn--primary">{{ \App\CPU\translate('update') }}
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    @push('script')
        ...
        <script>
            function initAutocomplete() {
                var myLatLng = {
                    lat: {{ $shipping_latitude ?? '-33.8688' }},
                    lng: {{ $shipping_longitude ?? '151.2195' }}
                };
