                        ...
                        <div class="media __incoming-msg">
                            ...
                            <div class="media-body">
                                ...
                                <span class="font-size-ms text-muted">
                                    <i
                                        class="czi-time align-middle {{ Session::get('direction') === 'rtl' ? 'ml-2' : 'mr-2' }}"></i>
                            ...
                            <div class="d-flex flex-wrap justify-content-end align-items-center gap-8">
                                <div>
                                    <a href="{{ route('support-ticket.close', [$ticket['id']]) }}"
                                        class="btn btn-secondary text-white">{{ \App\CPU\translate('close') }}</a>
                                </div>
                                <button class="btn btn--primary my-2"
                                    type="submit">{{ \App\CPU\translate('Submit message') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
