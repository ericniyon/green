...
@push('css_or_js')
    ...
    @else
        <meta property="twitter:card" content="{{ asset('storage/company') }}/{{ $web_config['fav_icon']->value }}" />
        <meta property="twitter:title" content="{{ route('shopView', [$shop['id']]) }}" />
        <meta property="twitter:url" content="{{ route('shopView', [$shop['id']]) }}">
    @endif
    ...
    <div class="container pb-5 mb-2 mb-md-4 __inline-67">
        <div class="row rtl">
            ...
            <div class="col-lg-12 mt-2">
                <div class="bg-white">
                    @if ($shop['id'] != 0)
                        <img class="__shop-page-banner" src="{{ asset('storage/shop/banner') }}/{{ $shop->banner }}"
                    ...
                    @else
                        ...
                        <img class="__shop-page-banner" src="{{ asset('storage/shop') }}/{{ $banner ?? '' }}"
                            onerror="this.src='https://res.cloudinary.com/dxuoorngr/image/upload/v1710758318/image-place-holder_cdnntk.png'"
                            alt="">
                    @endif
                </div>
            ...
            <div class="col-lg-12 rtl"
                style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};background:#fff">
                <div class="__rounded-10 bg-white"
                    ...
                    <div class="row d-flex justify-content-between seller-details">
                        ...
                        <div class="d-flex align-items-start p-2">
                            <div class="">
                                @if ($shop['id'] != 0)
                                    <img class="__inline-68" src="{{ asset('storage/shop') }}/{{ $shop->image }}"
                                        onerror="this.src='https://res.cloudinary.com/dxuoorngr/image/upload/v1710758318/image-place-holder_cdnntk.png'"
                                        alt="">
                                @else
                    ...
                    <div class=" rounded-lg " id="shop-sidebar">
                        <div class="">
                            ...
                            <div class="widget widget-categories mb-4 ">
                                <div>
                                    <div class="d-inline">
                                        <h3 class="widget-title font-bold __text-18px d-inline">
                                            {{ \App\CPU\translate('categories') }}</h3>
                                    </div>
                                </div>

                                <div class="accordion mt-2" id="shop-categories" style="background:#fff">
                                        ...
                                        <div class="card __inline-71">
                                            <div class="card-header p-1 flex-between">
                                                <div class="d-flex " style="justify-content: space-between">
                                                    ...
                                                    <strong class=" for-brand-hover cursor-pointer"
