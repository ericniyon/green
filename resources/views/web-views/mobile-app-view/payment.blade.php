...
<body class="toolbar-enabled">
    ...
    <div class="checkout_details container pb-5 mb-2 mb-md-4">
                ...
                <div class="col-md-6 mb-4" style="cursor: pointer">
                    <div class="card">
                        <div class="card-body" style="height: 100px">
                            ...
                            <button class="btn btn-block click-if-alone" type="submit" data-toggle="modal"
                        ...
                        <div class="card-body" style="height: 100px">
                            <form action="{{ url('/pay-ssl') }}" method="POST" class="needs-validation">
                                ...
                                <button class="btn btn-block click-if-alone" type="submit">
                                    <img width="150" src="{{ asset('assets/front-end/img/sslcomz.png') }}" />
                                </button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="card-body" style="height: 100px">
                            <form action="{!! route('payment-razor') !!}" method="POST">
                                ...
                                <script src="https://checkout.razorpay.com/v1/checkout.js"
                                    ...
                                    data-prefill.name="{{ $user->f_name }}" data-prefill.email="{{ $user->email }}" data-theme.color="#ff7529">
                                </script>
                            </form>
                            <button class="btn btn-block click-if-alone" type="button"
                                onclick="$('.razorpay-payment-button').click()">
                                <img width="150" src="{{ asset('assets/front-end/img/razor.png') }}" />
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body" style="height: 100px">
                            ...
                            <button class="btn btn-block click-if-alone" type="button"
                                ...
                                <img width="100" src="{{ asset('assets/front-end/img/paystack.png') }}" />
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body" style="height: 100px">
                            ...
                            <button class="btn btn-block click-if-alone" type="button"
                                ...
                                <img width="100" src="{{ asset('assets/front-end/img/senangpay.png') }}" />
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body" style="height: 100px">
                            <form class="needs-validation" method="POST" id="payment-form-paymob"
                                ...
                                {{ csrf_field() }}
                                <button class="btn btn-block click-if-alone" type="submit">
                                    <img width="150" src="{{ asset('assets/front-end/img/paymob.png') }}" />
                                </button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body" style="height: 100px">
                            <button class="btn btn-block click-if-alone"
                                onclick="location.href='{{ route('paytabs-payment') }}'" style="margin-top: -11px">
                    ...
                    <div class="card">
                        <div class="card-body" style="height: 100px">
                            <form method="POST" action="{{ route('flutterwave_pay') }}">
                                ...
                                <button class="btn btn-block click-if-alone" type="submit">
                                    <img width="200" src="{{ asset('assets/front-end/img/fluterwave.png') }}" />
                                </button>
                            </form>
                        </div>
                    </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="wallet_submit_button" aria-labelledby="exampleModalLongTitle"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">{{ \App\CPU\translate('wallet_payment') }}
                        </h5>
                    ...
                    <form action="{{ route('checkout-complete-wallet') }}" method="get" class="needs-validation">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input class="form-control" type="text"
                                        value="{{ \App\CPU\Helpers::currency_converter($customer_balance) }}"
                                        readonly>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary"
                                {{ $remain_balance > 0 ? '' : 'disabled' }}>{{ \App\CPU\translate('submit') }}</button>
                        </div>
                    </form>
                </div>
            </div>
