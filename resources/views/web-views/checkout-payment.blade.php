                        ...
                        @if ($digital_payment['status'] == 1)
                                    ...
                                    <div class="card cursor-pointer">
                                        <div class="card-body __h-100px">
                                            <button class="btn btn-block click-if-alone" type="button"
                                                ...
                                                <img width="150" src="{{ asset('assets/front-end/img/stripe.png') }}" />
                                            </button>
                                        ...
                                        <div class="card-body __h-100px">
                                            <form action="{!! route('payment-razor') !!}" method="POST">
                                                ...
                                                <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                    ...
                                                    data-prefill.email="{{ auth('customer')->user()->email }}" data-theme.color="#ff7529"></script>
                                            </form>
                                            <button class="btn btn-block click-if-alone" type="button"
                                    ...
                                    <div class="card cursor-pointer">
                                        <div class="card-body __h-100px">
                                            <button class="btn btn-block click-if-alone" id="bKash_button"
                                                ...
                                                <img width="100"
                                                    src="{{ asset('assets/front-end/img/bkash.png') }}" />
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if (isset($config) && $config['status'])
                                <div class="col-sm-6">
                                    <div class="card cursor-pointer">
                                        <div class="card-body __h-100px">
                                            <button class="btn btn-block click-if-alone __mt-n-11"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                @if ($remain_balance < 0)
                                    <label
                                        class="__color-crimson">{{ \App\CPU\translate('you do not have sufficient balance for pay this order!!') }}</label>
                                @endif
                            </div>
                        </div>
