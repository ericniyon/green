                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/product*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('seller/product/list') || Request::is('seller/product/stock-limit-list/in_house') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/coupon*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ \App\CPU\translate('Offers_&_Deals') }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/messages*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('seller/messages/chat/delivery-man') ? 'active' : '' }}">
                                    <a class="nav-link"
