                ...
                <a class="navbar-brand" href="{{ route('seller.dashboard.index') }}" aria-label="">
                    @if (isset($shop))
                        ...
                        <img class="navbar-brand-logo-mini"
                            ...
                            src="{{ asset("storage/app/public/shop/$shop->image") }}" alt="Logo" height="40">
                    @else
                        <img class="navbar-brand-logo-mini" src="{{ asset('assets/back-end/img/160x160/img1.jpg') }}"
                            alt="Logo" height="40">
                    @endif
            ...
            <div class="navbar-nav-wrap-content-right"
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    ...
                    <li class="nav-item d-none d-md-inline-block">
                        <!-- Notification -->
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle dropdown-toggle-left-arrow"
                                href="javascript:;"
                            ...
                            <div id="messageDropdown"
                                ...
                                <a class="dropdown-item position-relative"
                                    ...
                                    @php(
    $message_customer = \App\Model\Chatting::where(['seen_by_seller' => 0, 'seller_id' => auth('seller')->id()])->whereNotNull(['user_id'])->count()
)
                                    @if ($message_customer > 0)
                                        <span
                                            class="btn-status btn-sm-status-custom btn-status-danger">{{ $message_customer }}</span>
                                    @endif
                                ...
                                <a class="dropdown-item position-relative"
                                    ...
                                    @php(
    $message_d_man = \App\Model\Chatting::where(['seen_by_seller' => 0, 'seller_id' => auth('seller')->id()])->whereNotNull(['delivery_man_id'])->count()
)
                                    @if ($message_d_man > 0)
                                        <span
                                            class="btn-status btn-sm-status-custom btn-status-danger">{{ $message_d_man }}</span>
                                    @endif
        ...
        <div id="website_info" style="display:none;" class="bg-secondary w-100">
            <div class="p-3">
                ...
                <div class="bg-white p-1 rounded mt-2">
                    <a class="p-2  title-color" href="{{ route('seller.messages.chat', ['type' => 'customer']) }}">
                        <i class="tio-email"></i>
                ...
                <div class="bg-white p-1 rounded mt-2">
                    <a class="p-2 title-color" href="{{ route('seller.orders.list', ['pending']) }}">
                        <i class="tio-shopping-cart-outlined"></i>
