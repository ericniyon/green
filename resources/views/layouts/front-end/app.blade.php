...
<head>
    ...
    <link rel="stylesheet" media="screen" href="{{ asset('assets/front-end/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" media="screen" href="{{ asset('assets/front-end/css/custom.css') }}">
...
<script src="https://6valley.6amtech.com/public/assets/back-end/js/toastr.js"></script>
    ...
    <script>
        ...
        img.addEventListener("error", function(event) {
            event.target.src =
                'https://res.cloudinary.com/dxuoorngr/image/upload/v1710758318/image-place-holder_cdnntk.png';
            event.onerror = null
        })
