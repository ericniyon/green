            ...
            <div>
                <a href="{{ route('about-us') }}">
                    <div class="text-center">
                        <img class="size-60" src="{{ asset('assets/front-end/png/about company.png') }}" alt="">
                    </div>
                    <div class="text-center">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div>
                <a href="{{ route('contacts') }}">
                    <div class="text-center">
                        <img class="size-60" src="{{ asset('assets/front-end/png/contact us.png') }}" alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div>
                <a href="{{ route('helpTopic') }}">
                    <div class="text-center">
                        <img class="size-60" src="{{ asset('assets/front-end/png/faq.png') }}" alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
                        ...
                        <div class="row mt-4 {{ Session::get('direction') === 'rtl' ? ' flex-row-reverse' : '' }}">
                            <div class="col-md-7">
                                <div
                                    ...
                                    <div
                                        style="{{ Session::get('direction') === 'rtl' ? 'margin-right:23px;' : '' }}">
                                        <span
                                        ...
                                        <div>
                                            @if (auth('customer')->check())
                                                <a class="widget-list-link" href="{{ route('account-tickets') }}">
                                                    <span><i class="fa fa-user-o m-2"></i>
                                                        {{ \App\CPU\translate('Support Ticket') }} </span>
                                                </a><br>
                                            @else
                                                <a class="widget-list-link"
