        ...
        <div class="container">
            ...
            <div>
                ...
                @if ($currency_model == 'multi_currency')
                    <div
                        class="topbar-text dropdown disable-autohide {{ Session::get('direction') === 'rtl' ? 'mr-4' : 'mr-4' }}">
        ...
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <div class="input-group-overlay d-none d-md-block mx-4"
                    ...
                    <form action="{{ route('products') }}" type="submit" class="search_form">
                        <input class="form-control appended-form-control search-bar-input" type="text"
                            autocomplete="off" placeholder="{{ \App\CPU\translate('Search here ...') }}"
                            name="name">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    <div
                        class="navbar-tool dropdown {{ Session::get('direction') === 'rtl' ? 'mr-md-3' : 'ml-md-3' }}">
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu">
            <div class="container px-10px">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    @php(
    $categories = \App\Model\Category::with(['childes.childes'])->where('position', 0)->priority()->paginate(7)
)
                    <ul
                        ...
                        <li class="nav-item {{ !request()->is('/') ? 'dropdown' : '' }}">
                            ...
                            @else
                                <ul class="dropdown-menu __dropdown-menu-2"
                                    ...
                                    @endforeach
                                    <li class="dropdown">
                                        <a class="dropdown-item d-block text-center"
                                            href="{{ route('categories') }}"
                                            style="color: {{ $web_config['primary_color'] }} !important;">
                                            {{ \App\CPU\translate('view_more') }}
