    ...
    <section class="col-lg-8">
        ...
        @foreach ($cart as $group_key => $group)
            <div class="card __card cart_information mb-3">
                        ...
                        <thead class="thead-light">
                            <tr class="">
                                ...
                                @if ($shipping_type != 'order_wise')
                                    <th class="font-weight-bold __w-30p">{{ \App\CPU\translate('product_details') }}
                                    </th>
                                @else
                                ...
                                @if ($shipping_type != 'order_wise')
                                    <th class="font-weight-bold __w-15p">{{ \App\CPU\translate('shipping_cost') }}
                                    </th>
                                @endif
                                        ...
                                        <div class="d-flex">
                                            ...
                                            @foreach (json_decode($cartItem['variations'], true) as $key1 => $variation)
                                                <div class="text-muted mr-2">
                                                    <span
                                                        class="{{ Session::get('direction') === 'rtl' ? 'ml-2' : 'mr-2' }} __text-12px">
                                                        {{ $key1 }} : {{ $variation }}</span>
                ...
                <td>
                    <div>
                        ...
                        <input class="__cart-input" type="number" name="quantity[{{ $cartItem['id'] }}]"
                            ...
                            min="{{ $minimum_order->minimum_order_qty ?? 1 }}" value="{{ $cartItem['quantity'] }}">
                    </div>
                </td>
                <td>
                    <div>
                ...
                <td>
                    <button class="btn btn-link px-0 text-danger" onclick="removeFromCart({{ $cartItem['id'] }})"
                        type="button"><i
